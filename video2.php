<div class="main">
    ...
    <video autoplay id="videoElement" class="preview"></video>
    <canvas id="canvas" class="hidden preview" ></canvas>
        <div id="videoFallback" class="hidden">
            <img id="preview" class="preview" />
            <input type="hidden" name="MAX_FILE_SIZE" value="800000000000000000" />
        ...
        <div class="cama_mask screen"><img id="overlayer"/>
            <div class="control_panel screen">
